...
public class Plan {
    ...
    public Plan(int code, String name, String duration, String description, String days, String hours, int cantPeople, double pricepass, double priceticket, String souvenir) {
        this.code = code;
        this.name = name;
